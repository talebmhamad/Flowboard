...
namespace Flowboard.Intalio.Repositories
{
    public class TaskRepository
    {
        ...
        public async Task<DataTableResponse<InboxTaskDto>> GetInboxTasksAsync(List<long> userIds, TaskRequestDto request)
        {
            ...
            {
                throw new ArgumentNullException("One or more required arguments were null.", ex);
            }
            catch (InvalidOperationException ex)
            {
                throw new InvalidOperationException("An error occurred while querying inbox tasks.", ex);
            }
            catch (DbUpdateException ex)
            {
                throw new DbUpdateException("A database error occurred while retrieving inbox tasks.", ex);
            }
            catch (Exception ex)
            {
                throw new Exception("An unexpected error occurred while retrieving inbox tasks.", ex);
            }
        }
    }
}